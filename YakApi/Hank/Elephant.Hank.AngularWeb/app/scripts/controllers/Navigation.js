...
app.controller('NavCtrl', ['$scope', '$state', 'authService', '$stateParams', '$rootScope', '$transitions',
  function ($scope, $state, authService, $stateParams, $rootScope, $transitions) {
    ...
    $transitions.onStart({}, function(transitions){
      ...
      var toParams = transitions.params();
